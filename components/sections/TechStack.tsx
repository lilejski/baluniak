...
export function TechStack() {
  return (
    <section
      id="tech-stack"
      className="relative my-24 overflow-hidden border-t border-white/10 bg-black/30 px-5 py-16 pb-[max(2rem,env(safe-area-inset-bottom))] backdrop-blur-sm sm:px-6 md:py-24 md:pb-24"
