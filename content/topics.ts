...
export type PlannedTopic = {
  /** Shared across every language version — also the published frontmatter key. */
...
export const TOPIC_BACKLOG: PlannedTopic[] = [
  {
    ...
    targetQuery: {
      ...
      de: "onlineshop eröffnen schritt für schritt",
    },
    angle:
    ...
    tags: {
      pl: ["Sklepy online", "Małe firmy"],
      en: ["Online shops", "Small business"],
      de: ["Onlineshops", "Kleine Unternehmen"],
    },
    relatedSlugs: {
  ...
  },
  {
    ...
    targetQuery: {
      ...
      de: "ki chatbot für unternehmen lohnt sich das",
    },
    angle:
  ...
  },
  {
    ...
    targetQuery: {
      ...
      de: "warum ist meine website nicht bei google",
    },
    angle:
    ...
    tags: { pl: ["SEO", "Google"], en: ["SEO", "Google"], de: ["SEO", "Google"] },
    relatedSlugs: {
  ...
  },
  {
    ...
    targetQuery: {
      ...
      de: "auftragsverwaltung software kleines unternehmen",
    },
    angle:
    ...
    tags: {
      pl: ["Systemy", "Automatyzacja"],
      en: ["Systems", "Automation"],
      de: ["Systeme", "Automatisierung"],
    },
    relatedSlugs: {
      pl: ["co-da-sie-zautomatyzowac-w-malej-firmie"],
      en: ["what-to-automate-small-business"],
  ...
  },
  {
    ...
    targetQuery: {
      ...
      de: "produktfotos ohne fotostudio",
    },
    angle:
    ...
    tags: { pl: ["E-commerce", "AI"], en: ["E-commerce", "AI"], de: ["E-Commerce", "KI"] },
